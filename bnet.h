namespace BO6 {
    static uint32_t refdef = 0xD0831F8;
    static uint32_t name_array = 0xD0CC038;
    static uint32_t name_array_pos = 0x1838;
    static uint32_t name_size = 0xC8;
    static uint32_t loot_ptr = 0xE8393F0;
    ...
    static uint32_t camera_base = 0xCC50300;
    ...
    static uint32_t game_mode = 0xB9F6068;
    static uint32_t weapon_definitions = 0xCDF86B0;
    static uint32_t distribute = 0x108F1AF8;
...
namespace BO6 {
    uint64_t bnet_decrypt_client_info(uint64_t baseAddr, uint64_t peb)
    {
        ...
        rbx = driver::read<uint64_t>(baseAddr + 0xD07E048);
        if (!rbx)
            return rbx;
        rcx = peb;              //mov rcx, gs:[rax]
        //failed to trace. base: 00007FF7A9B90000 It's possibly wrong   rdx = 0000000000000000
        ...
        rbx ^= rcx;             //xor rbx, rcx
        rax ^= driver::read<uint64_t>(baseAddr + 0xB7A6C1C);            //xor rax, [0x0000000008C8A613]
    ...
    uint64_t bnet_decrypt_client_base(uint64_t client_info, uint64_t baseAddr, uint64_t peb)
    {
        ...
        case 0:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8FAE9]
            r13 = baseAddr + 0xDD05;                //lea r13, [0xFFFFFFFFFD4F6B62]
            r12 = baseAddr + 0x33D36DEA;            //lea r12, [0x000000003121FC2B]
            r15 = baseAddr + 0x16CBED5E;            //lea r15, [0x00000000141A7B93]
            rax ^= r11;             //xor rax, r11
            rax ^= r12;             //xor rax, r12
            rcx = r11;              //mov rcx, r11
            ...
            rax ^= rcx;             //xor rax, rcx
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E8C16]
            rax -= rcx;             //sub rax, rcx
            return rax;
        }
        case 1:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);              //mov r9, [0x0000000008C8F61C]
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E855D]
            ...
            rax ^= rcx;             //xor rax, rcx
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E8662]
            rax ^= rcx;             //xor rax, rcx
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E872A]
        ...
        case 2:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);              //mov r9, [0x0000000008C8F1AF]
            rcx = rax;              //mov rcx, rax
            ...
            rcx = ~rcx;             //not rcx
            rax *= driver::read<uint64_t>(rcx + 0x7);               //imul rax, [rcx+0x07]
            rcx = baseAddr + 0x40BA9587;            //lea rcx, [0x000000003E09193C]
            rax += r11;             //add rax, r11
            rax += rcx;             //add rax, rcx
            ...
            rax ^= rcx;             //xor rax, rcx
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E838D]
            rax += rcx;             //add rax, rcx
            rcx = rax;              //mov rcx, rax
        ...
        case 3:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8EC69]
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E7CF9]
            rax -= rcx;             //sub rax, rcx
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E7B7B]
            rax ^= rcx;             //xor rax, rcx
            rcx = rax;              //mov rcx, rax
            ...
            rcx = ~rcx;             //not rcx
            uintptr_t RSP_0x50;
            RSP_0x50 = baseAddr + 0x639AA956;               //lea rcx, [0x0000000060E928DA] : RSP+0x50
        ...
        case 4:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);              //mov r9, [0x0000000008C8E7F1]
        ...
        case 5:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8E0FB]
            rdx = 0;                //and rdx, 0xFFFFFFFFC0000000
            rcx = r11 * 0xFFFFFFFFFFFFFFFE;                 //imul rcx, r11, 0xFFFFFFFFFFFFFFFE
            rdx = _rotl64(rdx, 0x10);               //rol rdx, 0x10
            rax += rcx;             //add rax, rcx
            rdx ^= r10;             //xor rdx, r10
            rcx = baseAddr + 0x5F737FAA;            //lea rcx, [0x000000005CC1F19A]
            rdx = ~rdx;             //not rdx
            rax += rcx;             //add rax, rcx
            rax *= driver::read<uint64_t>(rdx + 0x7);               //imul rax, [rdx+0x07]
            rcx = rax;              //mov rcx, rax
            ...
            rax ^= rcx;             //xor rax, rcx
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E7079]
        ...
        case 6:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8DC9C]
            r12 = baseAddr + 0x50AF1F4F;            //lea r12, [0x000000004DFD8F53]
            rax += r11;             //add rax, r11
            rcx = r11;              //mov rcx, r11
            rcx ^= r12;             //xor rcx, r12
            rax -= rcx;             //sub rax, rcx
            ...
            rax *= rcx;             //imul rax, rcx
            rdx = 0;                //and rdx, 0xFFFFFFFFC0000000
            rcx = baseAddr + 0xEE8B;                //lea rcx, [0xFFFFFFFFFD4F5A89]
            rdx = _rotl64(rdx, 0x10);               //rol rdx, 0x10
            rcx -= r11;             //sub rcx, r11
            rax ^= rcx;             //xor rax, rcx
            rdx ^= r10;             //xor rdx, r10
        ...
        case 7:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8D78B]
            r15 = baseAddr + 0xBEE4;                //lea r15, [0xFFFFFFFFFD4F29D2]
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E6795]
            rax ^= rcx;             //xor rax, rcx
        ...
        case 8:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);              //mov r9, [0x0000000008C8D34B]
            rcx = rax;              //mov rcx, rax
            rcx >>= 0x1E;           //shr rcx, 0x1E
            rax ^= rcx;             //xor rax, rcx
            rcx = rax;              //mov rcx, rax
            ...
            rcx = ~rcx;             //not rcx
            rax *= driver::read<uint64_t>(rcx + 0x7);               //imul rax, [rcx+0x07]
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E61E6]
            rax += rcx;             //add rax, rcx
            rcx = rax;              //mov rcx, rax
        ...
        case 9:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8CC91]
            r12 = baseAddr + 0x6EC75C18;            //lea r12, [0x000000006C15BC11]
            rdx = baseAddr + 0xFCE2;                //lea rdx, [0xFFFFFFFFFD4F5B35]
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E5E49]
        ...
        case 10:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8C771]
            r12 = baseAddr + 0x240D8AB0;            //lea r12, [0x00000000215BE589]
            r13 = baseAddr + 0x24E689C1;            //lea r13, [0x000000002234E48E]
            rcx = r11 + r12 * 1;            //lea rcx, [r11+r12*1]
            rax ^= rcx;             //xor rax, rcx
            rdx = baseAddr + 0x3B21;                //lea rdx, [0xFFFFFFFFFD4E9252]
            rcx = r11;              //mov rcx, r11
            rdx *= r11;             //imul rdx, r11
            rcx = ~rcx;             //not rcx
            rax += rdx;             //add rax, rdx
        ...
        case 11:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8C2A0]
            rcx = rax;              //mov rcx, rax
            rcx >>= 0x15;           //shr rcx, 0x15
            rax ^= rcx;             //xor rax, rcx
            rcx = rax;              //mov rcx, rax
            ...
            rax ^= rcx;             //xor rax, rcx
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E5118]
            rax -= rcx;             //sub rax, rcx
            ...
            rcx >>= 0x20;           //shr rcx, 0x20
            rax ^= rcx;             //xor rax, rcx
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E54B0]
            rax ^= rcx;             //xor rax, rcx
            rcx = baseAddr + 0x5B0222F4;            //lea rcx, [0x00000000585073B7]
        ...
        case 12:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8BD35]
            r15 = baseAddr + 0x852;                 //lea r15, [0xFFFFFFFFFD4E58EF]
            ...
            rcx = ~rcx;             //not rcx
            rax *= driver::read<uint64_t>(rcx + 0x7);               //imul rax, [rcx+0x07]
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E4E56]
            rax ^= rcx;             //xor rax, rcx
            rax -= rcx;             //sub rax, rcx
        ...
        case 13:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8B975]
            r15 = baseAddr + 0x12585A59;            //lea r15, [0x000000000FA6A736]
            rcx = r11;              //mov rcx, r11
            rcx = ~rcx;             //not rcx
            rcx ^= r15;             //xor rcx, r15
            rax += rcx;             //add rax, rcx
            ...
            rcx ^= rax;             //xor rcx, rax
            rax = baseAddr + 0x78217335;            //lea rax, [0x00000000756FBE1C]
            rcx += r11;             //add rcx, r11
            rax += rcx;             //add rax, rcx
        ...
        case 14:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8B3F9]
            r15 = baseAddr + 0x3CF1;                //lea r15, [0xFFFFFFFFFD4E8452]
            rcx = rax;              //mov rcx, rax
            rcx >>= 0x16;           //shr rcx, 0x16
            rax ^= rcx;             //xor rax, rcx
            rcx = rax;              //mov rcx, rax
            ...
            rax -= rcx;             //sub rax, rcx
            rcx = baseAddr + 0x32FFEB8B;            //lea rcx, [0x00000000304E31F1]
            rcx = ~rcx;             //not rcx
            rcx *= r11;             //imul rcx, r11
            rax += rcx;             //add rax, rcx
            return rax;
        ...
        case 15:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6C85);             //mov r10, [0x0000000008C8AEA6]
            r12 = baseAddr + 0x23AC2B6F;            //lea r12, [0x0000000020FA6D7D]
            rcx = baseAddr;                 //lea rcx, [0xFFFFFFFFFD4E3FE5]
            rax -= rcx;             //sub rax, rcx
            rax += r11;             //add rax, r11
            rdx = r12;              //mov rdx, r12
            rdx = ~rdx;             //not rdx
    ...
    uintptr_t bnet_decrypt_bone_base(uint64_t baseAddr, uint64_t peb)
    {
        const uint64_t mb = baseAddr;
        uint64_t rax = mb, rbx = mb, rcx = mb, rdx = mb, rdi = mb, rsi = mb, r8 = mb, r9 = mb, r10 = mb, r11 = mb, r12 = mb, r13 = mb, r14 = mb, r15 = mb;
        rdx = driver::read<uint64_t>(baseAddr + 0x11D0A398);
        if (!rdx)
            return rdx;
        ...
        case 0:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);              //mov r9, [0x000000000574DAF2]
            rax = 0;                //and rax, 0xFFFFFFFFC0000000
            rax = _rotl64(rax, 0x10);               //rol rax, 0x10
            rax ^= r9;              //xor rax, r9
            rax = _byteswap_uint64(rax);            //bswap rax
            rdx *= driver::read<uint64_t>(rax + 0x11);              //imul rdx, [rax+0x11]
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA6AAB]
            rdx -= rax;             //sub rdx, rax
        ...
        case 1:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x000000000574D5ED]
            ...
            rax = _byteswap_uint64(rax);            //bswap rax
            rdx *= driver::read<uint64_t>(rax + 0x11);              //imul rdx, [rax+0x11]
            rax = baseAddr + 0x437D3D7F;            //lea rax, [0x000000003D77A453]
            rax = ~rax;             //not rax
            rcx += rax;             //add rcx, rax
            rdx ^= rcx;             //xor rdx, rcx
            rax = rdx;              //mov rax, rdx
            ...
            rdx ^= rax;             //xor rdx, rax
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA669E]
            rax += 0x3B261317;              //add rax, 0x3B261317
            rax += r11;             //add rax, r11
            rdx += rax;             //add rdx, rax
            rax = 0x85B82AEE944DCF96;               //mov rax, 0x85B82AEE944DCF96
            rdx ^= rax;             //xor rdx, rax
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA67AB]
            rdx += rax;             //add rdx, rax
            return rdx;
        }
        case 2:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);              //mov r9, [0x000000000574D123]
            rax = rdx;              //mov rax, rdx
        ...
        case 3:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);              //mov r9, [0x000000000574CCE0]
            r10 = baseAddr + 0x1314A155;            //lea r10, [0x000000000D0F00C4]
            rax = 0;                //and rax, 0xFFFFFFFFC0000000
            rax = _rotl64(rax, 0x10);               //rol rax, 0x10
            rax ^= r9;              //xor rax, r9
            rax = _byteswap_uint64(rax);            //bswap rax
            rdx *= driver::read<uint64_t>(rax + 0x11);              //imul rdx, [rax+0x11]
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA5E8F]
            rdx -= rax;             //sub rdx, rax
            rax = rdx;              //mov rax, rdx
            rax >>= 0x1F;           //shr rax, 0x1F
            rdx ^= rax;             //xor rdx, rax
        ...
        case 4:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x000000000574C9E1]
            ...
            rax = _byteswap_uint64(rax);            //bswap rax
            rdx *= driver::read<uint64_t>(rax + 0x11);              //imul rdx, [rax+0x11]
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA58D3]
        ...
        case 5:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);              //mov r9, [0x000000000574C533]
            r12 = baseAddr + 0x12426297;            //lea r12, [0x000000000C3CBA4F]
            rax = 0x7C5DF0A12057BE6;                //mov rax, 0x7C5DF0A12057BE6
            rdx -= rax;             //sub rdx, rax
            rax = 0x83F8FC0408B5D1AB;               //mov rax, 0x83F8FC0408B5D1AB
            rdx ^= rax;             //xor rdx, rax
            rax = baseAddr + 0x158DE932;            //lea rax, [0x000000000F883F4D]
            rax = ~rax;             //not rax
            ...
            rdx ^= rax;             //xor rdx, rax
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA5564]
        ...
        case 6:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x000000000574BF96]
            r12 = baseAddr + 0x6DA9DAD4;            //lea r12, [0x0000000067A42CF9]
            rax = rdx;              //mov rax, rdx
            ...
            rax >>= 0x26;           //shr rax, 0x26
            rdx ^= rax;             //xor rdx, rax
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA4FC1]
        ...
        case 7:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x000000000574BBA8]
            r13 = baseAddr + 0x4354;                //lea r13, [0xFFFFFFFFF9FA9190]
            rdx ^= r11;             //xor rdx, r11
            rax = rdx;              //mov rax, rdx
        ...
        case 8:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x000000000574B70B]
            r12 = baseAddr + 0x7D814959;            //lea r12, [0x00000000777B92F8]
            rdx -= r11;             //sub rdx, r11
            ...
            rdx ^= rax;             //xor rdx, rax
            rdx += r11;             //add rdx, r11
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA4842]
            rdx ^= rax;             //xor rdx, rax
            return rdx;
        }
        case 9:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);              //mov r9, [0x000000000574B3C9]
            rax = rdx;              //mov rax, rdx
            ...
            rdx ^= rax;             //xor rdx, rax
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA4220]
            rdx ^= rax;             //xor rdx, rax
            rax = 0;                //and rax, 0xFFFFFFFFC0000000
            rax = _rotl64(rax, 0x10);               //rol rax, 0x10
            rax ^= r9;              //xor rax, r9
        ...
        case 10:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x000000000574AEA3]
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA3FD7]
            rdx -= rax;             //sub rdx, rax
            rcx = rdx;              //mov rcx, rdx
            rcx >>= 0x27;           //shr rcx, 0x27
            rcx ^= rdx;             //xor rcx, rdx
            rdx = baseAddr + 0x9688;                //lea rdx, [0xFFFFFFFFF9FAD553]
            rdx *= r11;             //imul rdx, r11
            rdx += rcx;             //add rdx, rcx
            rax = rdx;              //mov rax, rdx
            rax >>= 0x13;           //shr rax, 0x13
        ...
        case 11:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x000000000574A9C8]
            rcx = 0;                //and rcx, 0xFFFFFFFFC0000000
            rax = baseAddr + 0x1E13DCA3;            //lea rax, [0x00000000180E154B]
            rax = ~rax;             //not rax
            rcx = _rotl64(rcx, 0x10);               //rol rcx, 0x10
            rax += r11;             //add rax, r11
            rcx ^= r10;             //xor rcx, r10
            ...
            rcx = _byteswap_uint64(rcx);            //bswap rcx
            rdx *= driver::read<uint64_t>(rcx + 0x11);              //imul rdx, [rcx+0x11]
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA387A]
            ...
            rdx ^= rax;             //xor rdx, rax
            rcx = baseAddr + 0x7C2A0085;            //lea rcx, [0x00000000762439C3]
            rcx = ~rcx;             //not rcx
            rcx *= r11;             //imul rcx, r11
            rax = rdx;              //mov rax, rdx
        ...
        case 12:
        {
            r9 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);              //mov r9, [0x000000000574A573]
            rax = 0;                //and rax, 0xFFFFFFFFC0000000
            rax = _rotl64(rax, 0x10);               //rol rax, 0x10
            rax ^= r9;              //xor rax, r9
            rax = _byteswap_uint64(rax);            //bswap rax
        ...
        case 13:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x000000000574A0DC]
            rax = rdx;              //mov rax, rdx
            rax >>= 0xE;            //shr rax, 0x0E
            rdx ^= rax;             //xor rdx, rax
            rax = rdx;              //mov rax, rdx
            ...
            rcx = _byteswap_uint64(rcx);            //bswap rcx
            rdx *= driver::read<uint64_t>(rcx + 0x11);              //imul rdx, [rcx+0x11]
            rcx = baseAddr + 0x7FFA;                //lea rcx, [0xFFFFFFFFF9FAB2CF]
            ...
            rdx *= rax;             //imul rdx, rax
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA2F3F]
        ...
        case 14:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x0000000005749B24]
            rax = rdx;              //mov rax, rdx
            rax >>= 0x1C;           //shr rax, 0x1C
            rdx ^= rax;             //xor rdx, rax
            rax = rdx;              //mov rax, rdx
            rax >>= 0x38;           //shr rax, 0x38
            rax ^= rdx;             //xor rax, rdx
            rdx = baseAddr;                 //lea rdx, [0xFFFFFFFFF9FA2A72]
            rax -= rdx;             //sub rax, rdx
            ...
            rax = _byteswap_uint64(rax);            //bswap rax
            rdx *= driver::read<uint64_t>(rax + 0x11);              //imul rdx, [rax+0x11]
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA2980]
            rdx -= rax;             //sub rdx, rax
        ...
        case 15:
        {
            r10 = driver::read<uint64_t>(baseAddr + 0xB7A6D59);             //mov r10, [0x00000000057496A3]
            rax = rdx;              //mov rax, rdx
            rax >>= 0x25;           //shr rax, 0x25
            rdx ^= rax;             //xor rdx, rax
            rdx -= r11;             //sub rdx, r11
            ...
            rcx = _rotl64(rcx, 0x10);               //rol rcx, 0x10
            rcx ^= r10;             //xor rcx, r10
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA26CD]
            ...
            rdx *= rax;             //imul rdx, rax
            rdx -= r11;             //sub rdx, r11
            rax = baseAddr;                 //lea rax, [0xFFFFFFFFF9FA25CC]
            rdx -= rax;             //sub rdx, rax
    ...
    uintptr_t bnet_get_bone_index(uint32_t bone_index, uint64_t baseAddr)
    {
        ...
        rbx = baseAddr;                 //lea rbx, [0xFFFFFFFFFD4965BE]
        ...
        rcx -= rax;             //sub rcx, rax
        rax = driver::read<uint16_t>(rcx + rbx * 1 + 0xA6FB9E0);                //movzx eax, word ptr [rcx+rbx*1+0xA6FB9E0]
        ...
        rcx -= rax;             //sub rcx, rax
        rsi = driver::read<uint16_t>(rcx + rbx * 1 + 0xA70A610);                //movsx esi, word ptr [rcx+rbx*1+0xA70A610]
        return rsi;
    }
}